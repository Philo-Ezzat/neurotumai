...
namespace NeuroTumAI.Repository.Data.Migrations
{
    ...
    [Migration("20250611095714_updateTicketLabDate")]
    partial class updateTicketLabDate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NeuroTumAI.Core.Entities.Lab", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NeuroTumAI.Core.Entities.Ticket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("AiGeneratedFilePath")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("DrFinalDesc")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DrInitialDesc")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("LabDescribtion")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("LabId")
                        .HasColumnType("int");

                    b.Property<bool>("NeedMRI")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("NeuroTumAI.Core.Entities.Appointment.Appointment", b =>
                {
                    ...
                    b.HasOne("NeuroTumAI.Core.Entities.Ticket", "Ticket")
                        .WithMany()
            ...
            modelBuilder.Entity("NeuroTumAI.Core.Entities.Ticket", b =>
                {
                    ...
                    b.HasOne("NeuroTumAI.Core.Entities.Lab", "Lab")
                        .WithMany()
                        .HasForeignKey("LabId");
