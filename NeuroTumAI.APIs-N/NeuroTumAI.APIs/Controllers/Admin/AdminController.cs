...
namespace NeuroTumAI.APIs.Controllers.Admin
{
	public class AdminController : BaseApiController
	{
        ...
        public AdminController(IAdminService adminService, IMapper mapper, IDoctorService doctorService, IClinicService clinicService, IDashboardService dashboardService, IContactUsService contactUsService, ILabService labService)
		{
        ...
        [Authorize(Roles = "Admin")]
        [HttpPost("addLab")]
        public async Task<ActionResult> AddLab(LabDto model)
        {
            await _labService.AddLabAsync(model);
